    ...
    if request.method == "POST":
        try:
            ...
            system_prompt = (
                ...
                "\U0001f52e あなたの役割は、上記のカードが表す意味を相談内容にあわせて説明することです。\n\n"
                "\U0001f4ac 回答スタイルのルール：\n"
            ...
            reply = f"<strong>{selected_card}（{selected_position}）</strong><br><br>" + response.choices[0].message.content.strip()
